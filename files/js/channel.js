...
function getpage() {
	...
	_hmt.push(['_trackPageview', 'channel.html?cid=cidstr&channel=channelstr&page=pagestr'.replace(/cidstr/g, GetQueryString("cid")).replace(/channelstr/g, GetQueryString("channel")).replace(/pagestr/g, page)]);
}